export const environment = {
  ...
  // firebaseConfig: {
  //   apiKey: "AIzaSyB0NAHnvKbBr_OXWfGTKcmt0FWENDcT3wM",
  //   authDomain: "fed-catalogo-controle-esc-dev.firebaseapp.com",
  //   projectId: "fed-catalogo-controle-esc-dev",
  //   storageBucket: "fed-catalogo-controle-esc-dev.firebasestorage.app",
  //   messagingSenderId: "143701375200",
  //   appId: "1:143701375200:web:8f263c3afbbeb719c3b885",
  //   measurementId: "G-F3WVJ201LM"
  // }
};
